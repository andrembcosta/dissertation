...
{\begin{mdframed}[backgroundcolor=alternativegray,nobreak=true,linewidth=0pt,startinnercode={\baselineskip=0.8cm}]\begin{mdalternative}\vspace{-0.5em}}
...
{\begin{mdframed}[backgroundcolor=examplegray,nobreak=true,linewidth=0pt,startinnercode={\baselineskip=0.8cm}]\begin{mdexample}\vspace{-0.5em}}
