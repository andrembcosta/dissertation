...
%-----------------------------------------------------------------------------%
\author{Tianchen Hu}
\title{A Variational Framework for Phase-Field Fracture Modeling with Applications to Microstructure Fragmentation, Dessication, Ductile Failure, and Spallation}
