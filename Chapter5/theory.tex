...
\label{section: Chapter5/theory/constitutive/elasticity}
...
\label{section: Chapter5/theory/constitutive/plastic_flow}
...
\label{section: Chapter5/theory/constitutive/flow_stress}

Three commonly used plastic energy density functions and their viscous counterparts are considered in this chapter. The first plastic energy density resembles a simple linear hardening law:
\begin{subequations}
  \begin{align}
...
\begin{remark}\label[remark]{remark: tqf}
  Consider only the plastic dissipation in the thermodynamic process. The Taylor-Quinney factor should satisfy the following inequality to yield a positive heat generation:
  \begin{align}
    \delta + \delta_T = g^p \tqf \sigma_y^T \epdot - g^p (1-\tqf) \dfrac{Q}{RT} \sigma_y^T \epdot > 0.
  \end{align}
...
\label{section: Chapter5/theory/constitutive/fracture}
...
\end{align}
supplemented by the constitutive relations including the stress-strain relations presented in \Cref{section: Chapter5/theory/constitutive/elasticity}, the yield surface and loading/unloading conditions presented in \Cref{section: Chapter5/theory/constitutive/plastic_flow,section: Chapter5/theory/constitutive/flow_stress}, the modified fracture thermodynamic conjugates \Cref{section: Chapter5/theory/constitutive/fracture}, and the conductive heat flux \eqref{eq: conductive heat flux}. Substituting all of them into the governing equations, the fracture evolution equation can be expanded as
\begin{align}
...
\end{align}
Next, minimizing the incremental local energy density subject the flow rule constraints (similar to the derivation in \Cref{section: Chapter5/theory/constitutive/plastic_flow}) yields
\begin{subequations}
  \begin{align}
    \begin{split}
