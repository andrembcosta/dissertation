\begin{figure}[htb!]
  ...
  \end{subfigure}
  \caption[The stress strain curve, the degradation for the fracture toughness, and the corresponding energy conservation for different values of $\beta$.]{(a, c) The stress strain curve and the degradation for the fracture toughness and (b, d) the corresponding energy conservation. In (a-b), $C=\beta = 1$ and $\dfrac{\psi_cc_0a}{\Gc} = 0.0021$. In (c-d), $C=\beta=0.5$, $\varepsilon_0 = 0.001$, and $\dfrac{\psi_cc_0a}{\Gc} = 0.0021$. }
