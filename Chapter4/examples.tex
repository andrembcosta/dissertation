...
Finally, in \Cref{section: Chapter4/examples/3D} we present stochastic simulations of a soil dessication process in three dimensions.
...
\input{Chapter4/figures/1D/simplification}

\input{Chapter4/figures/1D/supersuperposition}
...
\input{Chapter4/figures/1D/compare_analytical_numerical}
...
\input{Chapter4/figures/2D/simplification}
...
\input{Chapter4/figures/2D/compare_correlation_length.tex}

\input{Chapter4/figures/2D/compare_smoothness.tex}

\input{Chapter4/figures/2D/statistics_correlation_length.tex}

\input{Chapter4/figures/2D/statistics_smoothness.tex}
...
\input{Chapter4/figures/2D/compare_correlation.tex}
...
\input{Chapter4/figures/2D/statistics_sensitivity.tex}
...
\input{Chapter4/figures/2D/compare_morphology.tex}

\input{Chapter4/figures/2D/compare_sensitivity.tex}
...
\input{Chapter4/figures/2D/japanese_experiment.tex}
...
\input{Chapter4/figures/3D/inverse.tex}
...
\input{Chapter4/figures/3D/calibrated.tex}
...
\input{Chapter4/figures/3D/3D.tex}
